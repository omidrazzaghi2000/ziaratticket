...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-tv_9dks#cm8mltu)*q1$j6-1i((@-!3-_fh8ld322==r^@sprl')
...
KAVENEGAR_API_KEY = os.environ.get(
    'KAVENEGAR_API_KEY',
    '376E74796B6A6D7862596C794A61534C374F4E6F494D6667323247416A67706B4A4130665176313575326B3D',
)

# کش اوقات شرعی - 1 ساعت
PRAYER_TIMES_CACHE_SECONDS = 3600
