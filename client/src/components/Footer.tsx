        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-white/80 text-sm leading-relaxed">
              سامانه رزرو کاروان کربلا با هدف تسهیل سفر زیارتی زائران به عتبات عالیات راه‌اندازی شده است. تمامی کاروان‌های ما دارای مجوز رسمی بوده و با بالاترین استانداردهای خدماتی فعالیت می‌کنند.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="#" className="text-white/80 hover:text-white transition">صفحه اصلی</a></li>
              <li><a href="#caravans" className="text-white/80 hover:text-white transition">کاروان‌ها</a></li>
              <li><a href="#guide" className="text-white/80 hover:text-white transition">راهنمای زائرین</a></li>
              <li><a href="#faq" className="text-white/80 hover:text-white transition">سوالات متداول</a></li>
              <li><a href="#contact" className="text-white/80 hover:text-white transition">تماس با ما</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="#caravans" className="text-white/80 hover:text-white transition">رزرو کاروان‌های عتبات</a></li>
              <li><a href="#caravans" className="text-white/80 hover:text-white transition">کاروان‌های ویژه اربعین</a></li>
              <li><a href="#caravans" className="text-white/80 hover:text-white transition">سفرهای خانوادگی</a></li>
              <li><a href="#guide" className="text-white/80 hover:text-white transition">بیمه زائرین</a></li>
              <li><a href="#contact" className="text-white/80 hover:text-white transition">مشاوره سفر زیارتی</a></li>
            </ul>
          </div>
          
          <div>
            <h4 className="text-lg font-bold mb-4">عضویت در خبرنامه</h4>
            <p className="text-white/80 text-sm mb-3">برای اطلاع از آخرین کاروان‌ها و تخفیف‌های ویژه، در خبرنامه ما عضو شوید.</p>
